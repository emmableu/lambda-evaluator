...
//
//     // divTest = $('<div>').html('<a id = "nextbutton"> next </a>');
//     // $("#ag-results").append(divTest);
//
//     // document.getElementById('nextbutton').innerHTML += '<li class="list-group-item"> <%= j(taxonomies_select_tag( 'statistic[taxonomy]', Folders::Taxonomy, Folders::Taxonomy::TAXONOMY_KEY, level: 3, path: 'folders/taxonomies', ' +
//     // 'include_blank: true, class: 'required form-control test_taxo'))%> </li>';
//
